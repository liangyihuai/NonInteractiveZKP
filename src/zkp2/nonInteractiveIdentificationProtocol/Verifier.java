...
public class Verifier {
    public static boolean verify() throws IOException {
        ...
        /*the message sent by prover*/
        FileInputStream messageM = new
                FileInputStream("C:\\Users\\media\\Desktop\\temp\\sample.txt");
        String hashMessage =
        ...
        /*verifies if g^u mod p which is the LHS = R.Y^c mod p which is the RHS
        * modular multiplication is carried out in this fashion (R(mod p))* Y^c(mod p))(mod p)*/
